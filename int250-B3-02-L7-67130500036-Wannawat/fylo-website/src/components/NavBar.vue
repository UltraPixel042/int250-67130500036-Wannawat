...
<template>
  ...
  <div class="w-full dark:bg-[#1c2431]">
  <!-- Header -->
  <header class="container mx-auto pt-10 px-6 text-center h-40 md:h-25">
    <!-- Dynamic Logo -->
    <div
      class="bg-logo-light-mode dark:bg-logo-dark-mode bg-no-repeat h-20 w-48 mx-auto md:mx-0 md:absolute top-10 left-10"
    >
      <img src="../../public/images-fylo/logo-light-mode.svg" alt="Light Fylo Logo" v-if="!isDark">
      <img src="../../public/images-fylo/logo-dark-mode.svg" alt="Dark Fylo Logo" v-if="isDark">
    </div>
    <!-- Menu -->
    <div
      class="flex items-center justify-center space-x-4 md:space-x-10 md:absolute top-12 right-10"
    >
      <a href="#features" class="hover:text-accent-cyan dark:text-white">Features</a>
      <a href="#faq" class="hover:text-accent-cyan dark:text-white">FAQs</a>
      <a href="#testimonials" class="hover:text-accent-cyan dark:text-white">Testimonials</a>
