...
const myProfile = {
  ...
  following: "1114",
  projects: "10+",
  facebook: "https://www.facebook.com/wannawat.siriarkanay",
  instagram: "https://www.instagram.com/4thvowelineng/",
...
<template>
  <div
    class="flex items-center justify-center gap-8 min-h-screen bg-linear-to-br from-green-500 to-sky-400"
  >
    <ProfileCard 
      ...
      :name="myProfile.name"
      :subheading="myProfile.subheading"
